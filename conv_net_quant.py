...
#layer_conv1=tf.py_func(fa,[layer_conv1],tf.float32)

print("Passed activation of layer 1 ")
layer_flat_temp=flatten_layer(layer_conv1)


print("Passed flattening of layer 1 ")

#create second conv layer

#fw,fa,fg=get_dorefa(7,7,7)
...
layer_conv2=fa(cabs(layer_conv2))   
#    
