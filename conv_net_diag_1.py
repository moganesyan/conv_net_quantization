...
layer_flat=tf.Print(layer_flat,[layer_flat],message="Flat layer:",summarize=500)
...
#layer_fc1=fg(layer_fc1)
layer_fc1=tf.Print(layer_fc1,[weights_fc1],message="weights fc1",summarize=500)
layer_fc1=tf.Print(layer_fc1,[layer_fc1],message="fc1",summarize=500)
