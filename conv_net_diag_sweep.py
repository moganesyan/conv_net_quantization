...
#        print("passed")
        ...
        if max(temp)==0:
            ...
            chosen_prec=temp.index(max(temp))+2
...
#layer_conv2=tf.Print(layer_conv2,[weights_conv2],message="conv2 weights",summarize=sum_size)
...
print("conv2 weights")
#print(weights_conv1)
print(session.run(weights_conv2, feed_dict={bitw:BITW,bita:BITA,bitg:BITG}))
